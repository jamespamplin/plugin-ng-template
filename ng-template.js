...
exports.translate = function( load ) {
  ...
  return "var src='" + santiseSource( load.source ) + "';require('angular').module('ng').run(['$templateCache', function(c) { c.put('" + url + "', src) }]);module.exports = { template: src, templateUrl: '" + url + "' }";
};
